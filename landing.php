                ...
                <table class=" w-5xl bg-white rounded-lg shadow-lg mx-auto">
                    ...
                    <tbody class="text-gray-700">
                        ...
                        <tr class="border-b border-gray-200 hover:bg-indigo-100 transition-all duration-300">
                            ...
                            <td class="px-6 py-4 font-semibold text-blue-700">Judul Buku 1</td>
                            <td class="px-6 py-4">Penulis Buku 1</td>
                            <td class="px-6 py-4">2022</td>
                            <td class="px-6 py-4">Deskripsi singkat tentang buku 1. Buku ini memberikan wawasan mendalam mengenai dunia teknologi.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
